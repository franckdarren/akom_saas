// app/(dashboard)/dashboard/menu/categories/[id]/families/create-family-dialog.tsx
'use client'
...
/**
 * Dialog de création d'une nouvelle famille
 * 
 * Ce composant utilise le pattern "children" de shadcn/ui :
 * L'élément enfant (généralement un Button) devient le déclencheur du dialog
 * 
 * Utilisation :
 * <CreateFamilyDialog categoryId="abc" categoryName="Plats">
...
export function CreateFamilyDialog({ 
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        if (result.error) {
            ...
            setOpen(false)
            setIsLoading(false)
            toast.success(`Famille "${data.name}" créée avec succès`)
            router.refresh()
            // Reset form
